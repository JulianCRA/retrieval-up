...
def _cargar_modelo(nombre=MODELO_DEFAULT, device="cuda", compute_type="int8"):
...
def transcribir_whisper(paths, nombre_modelo=MODELO_DEFAULT, device="cuda", compute_type="int8", batch_size=BATCH_SIZE):
